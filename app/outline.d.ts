...
export class Outline {
  ...
  * @param key - The key of the metadata to get.
  * @returns The metadata value or undefined if not set.
  */
  getMetadata(key: string): string | undefined;
  
  /**
  * Set outline metadata. Stored in .bike and .opml outline formats. Not
  * stored in the plaintext format.
  * @param key - The key of the metadata to get.
  * @param value - The value of the metadata to set. If value is undefined
  * the metadata will be removed.
  */
  ...
  */
  scheduleQuery(
    path: OutlinePath,
    handler: (value: OutlinePathValue) => void,
  ): Disposable;
...
export interface AttributedString {
  ...
  */
  addAttributes(
    attributes: Record<TextAttributeName, AttributeValue>,
    range?: Range,
  ): void;
